#' Returns matrix with results from lm() function. Creates matrices with results from a set of linear regressions
#' 
...
#' @return $matrix returns a matrix with all the results from the regression, $latex returns a latex table with all the results from the regressio
#' @examples 
